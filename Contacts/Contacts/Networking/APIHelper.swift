...
enum APIEnvironment: APIEnvironmentRequirements {
    ...
    var baseURL: String {
        ...
        switch self {
        case .alpha :   return "http://gojek-contacts-app.herokuapp.com"
        case .beta:     return "http://gojek-contacts-app.herokuapp.com"
        case .preProd:  return "http://gojek-contacts-app.herokuapp.com"
        case .prod:     return "http://gojek-contacts-app.herokuapp.com"
        }
    }
